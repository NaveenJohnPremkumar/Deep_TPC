...
if __name__ == '__main__':
    ...
    #GPT2MM specific config
    parser.add_argument('--mm_layers', type=int, nargs='+', default=[6,7,8,9,10,11,12], help='indices of GPT2 layers to replace with MM blocks')
    parser.add_argument('--num_fusion_tokens', type=int, default=20, help='number of learnable fusion tokens for multimodal attention')
    ...
    parser.add_argument('--add_cross_attention', action='store_true', default=True)
    parser.add_argument('--use_return_dict', action='store_true', default=True)
